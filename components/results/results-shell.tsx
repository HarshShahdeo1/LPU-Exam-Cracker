  ...
  return (
    <main className="min-h-screen bg-[#f9fafb]">
      <div className="mx-auto flex max-w-[1500px]">
        ...
        {/* ── Sidebar ──────────────────────────────── */}
        <aside className="hidden sticky top-0 h-screen w-[280px] shrink-0 overflow-y-auto scrollbar-thin border-r border-[#e8ebf2] bg-white px-5 py-8 xl:flex xl:flex-col">
